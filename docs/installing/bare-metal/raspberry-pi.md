...
- Flatcar Container Linux support for Raspberry Pi is still in it's early stages and is not thoroughly tested.
...
The target device could be a USB or SD Card. 
